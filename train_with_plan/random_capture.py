...
if __name__ == "__main__":
    ...
    planner_cfg["experiment_id"] = 1
    planner_cfg["radius_start"] = args.radius_start
    planner_cfg["radius_end"] = args.radius_end
    planner_cfg["sampling_method"] = "random"
    planner_cfg["sampling_num"] = args.candidate_views_num
    planner_cfg["scheduling_num"] = 0
    ...
    if args.sampling_method == "random":
        ...
        for i in range(args.candidate_views_num):
            seed = int(time.time_ns() % 1000000) #need to change
            view_list[i] = uniform_sampling(args.radius_start, args.radius_end, args.phi_min, seed)
